# backend/chat_app/ai_providers/text_models.py
import requests
...
def query_openrouter(prompt: str, model: str, system_prompt: str = None, 
                   max_tokens: int = 1024, language: str = "en") -> Tuple[str, None]:
    headers = {
